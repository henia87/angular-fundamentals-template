...
export const requestEditCourse = createAction(CoursesConstants.REQUEST_EDIT_COURSE, props<{id: string, course: Omit<Course, "id" | "creationDate">}>());
...
export const requestCreateCourse = createAction(CoursesConstants.REQUEST_CREATE_COURSE, props<{course: Omit<Course, "id" | "creationDate">}>());
